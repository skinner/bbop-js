...
function renderer(parent, row_descriptors, col_descriptors,
    ...
    this.last_vert_gridline.className = vert_class;
    ...
    this.last_horiz_gridline.className = horiz_class;
    ...
    this.inner_header_style = [
        ...
        "-moz-transform: rotate(-90deg) translate(" + inner_offset + "px);",
    ...
    // matrix is first created, so we set a bunch of styles without
