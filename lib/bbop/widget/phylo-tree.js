...
renderer.prototype.display = function () {
    ...
    this.disable_width_transition();
    this.width_changed(this.parent.clientWidth);
    var self = this;
    setTimeout(function() { self.enable_width_transition(); }, 0);
};

// don't use CSS transitions for container width changes while there's
// a width drag operation underway
renderer.prototype.disable_width_transition = function() {
    this.container.style.transitionProperty = "height";
};
renderer.prototype.enable_width_transition = function() {
    this.container.style.transitionProperty = "width, height";
};
...
renderer.prototype.nodes = function() {
